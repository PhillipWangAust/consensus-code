...
Folder2='../../Output_new/';
fId = fopen(strcat(Folder2, 'uncertainActiveLearnerBatchnorel_', DatasetName, '_20.txt'), 'w');
fId2 = fopen(strcat(Folder2, 'uncertainActiveLearnerBatchfScorenorel_', DatasetName, '_20.txt'), 'w');
fId3 = fopen(strcat(Folder2, 'uncertainActiveLearnerBatchconfusionnorel_', DatasetName, '_20.txt'), 'w');
fId4 = fopen(strcat(Folder2, 'uncertainActiveBatchrunningtimenorel_', DatasetName, '_20.txt'), 'w');
fprintf(fId, '\n-----------------------------------------------------\n');
fprintf(fId2, '\n-----------------------------------------------------\n');
fprintf(fId, '\nDataset is %s\n',DatasetName);
fprintf(fId2, '\nDataset is %s\n',DatasetName);
...
for i=1:expNum
	...
	% predictions for unlabelled data
		...
		%find Consensus over unlabelled Data
                oc_mach_unlabelled=OnlineCM_norel(A_unlabelled,B_unlabelled,alpha);
