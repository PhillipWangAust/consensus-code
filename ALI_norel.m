...
Folder2='../../Output_new/';
fId = fopen(strcat(Folder2, 'influenceActiveLearnerBatchnorel_', DatasetName, '_20.txt'), 'w');
fId2 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchfScorenorel_', DatasetName, '_20.txt'), 'w');
fId3 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchconfusionnorel_', DatasetName, '_20.txt'), 'w');
fId4 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchrunningtimenorel_', DatasetName, '_20.txt'), 'w');
fprintf(fId, '\n-----------------------------------------------------\n');
fprintf(fId2, '\n-----------------------------------------------------\n');
fprintf(fId, '\nDataset is %s\n',DatasetName);
fprintf(fId2, '\nDataset is %s\n',DatasetName);
...
for i=1:expNum
	...
	% predictions for labelled data
		...
		oc_mach_testdata=OnlineCM_norel(A,B,alpha);
		...
		tic;
                oc_mach_labelled=OnlineCM_norel(A_labelled,B_labelled,alpha);
