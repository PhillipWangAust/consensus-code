...
%while(initialtrainingSize<=300)
	fId = fopen(strcat(Folder2, 'uncertainbatch_', DatasetName,'_',num2str(batch_size), '.txt'), 'w');
	fId2 = fopen(strcat(Folder2, 'uncertainbatchfScore_', DatasetName,'_',num2str(batch_size),'.txt'), 'w');
	fId3 = fopen(strcat(Folder2, 'uncertainbatchconfusion_', DatasetName,'_',num2str(batch_size),'.txt'), 'w');
	fprintf(fId, '\n-----------------------------------------------------\n');
	fprintf(fId2, '\n-----------------------------------------------------\n');
	fprintf(fId, '\nDataset is %s\n',DatasetName);
	fprintf(fId2, '\nDataset is %s\n',DatasetName);
