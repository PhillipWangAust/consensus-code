...
while(initialtrainingSize<=300)
	fId = fopen(strcat(Folder2, 'influence_', DatasetName,'_',num2str(initialtrainingSize),'.txt'), 'w');
	fId2 = fopen(strcat(Folder2, 'influencefScore_', DatasetName,'_',num2str(initialtrainingSize),'.txt'), 'w');
	fprintf(fId, '\n-----------------------------------------------------\n');
	fprintf(fId2, '\n-----------------------------------------------------\n');
	fprintf(fId, '\nDataset is %s\n',DatasetName);
	fprintf(fId2, '\nDataset is %s\n',DatasetName);
