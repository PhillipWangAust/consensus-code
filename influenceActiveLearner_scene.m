...
Folder2='../../Output_new/';
fId = fopen(strcat(Folder2, 'influenceActiveLearnerBatch_', DatasetName, '.txt'), 'w');
fId2 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchfScore_', DatasetName, '.txt'), 'w');
fId3 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchconfusion_', DatasetName, '.txt'), 'w');
fId4 = fopen(strcat(Folder2, 'influenceActiveLearnerBatchrunningtime_', DatasetName, '.txt'), 'w');
fprintf(fId, '\n-----------------------------------------------------\n');
fprintf(fId2, '\n-----------------------------------------------------\n');
fprintf(fId, '\nDataset is %s\n',DatasetName);
fprintf(fId2, '\nDataset is %s\n',DatasetName);
