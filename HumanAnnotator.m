classdef HumanAnnotator< handle
    ...
    methods
	function obj = HumanAnnotator(Datasetname,nMod,fraction,flipProbability)
		...
		for l = 1 : train_label_count
			...
			centroid{l}=temp_centroid;	
        		for i = 1 : train_instance_count
                		for j= 1: obj.nModels
                        		annotatorLabels(j,i,l)=getLabelOfAnnotator(j,cluster(i),1-temp_centroid(cluster(i)),lLabels(i));
                		end
        		end
