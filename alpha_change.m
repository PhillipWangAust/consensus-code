...
for i=1:expNum
fId = fopen(strcat(Folder2, 'PassiveLearnerBatch_', DatasetName, '_',expNum,'_20.txt'), 'w');
fId2 = fopen(strcat(Folder2, 'PassiveLearnerBatchfScore_', DatasetName,'_',expNum, '_20.txt'), 'w');
fId3 = fopen(strcat(Folder2, 'PassiveLearnerBatchconfusion_', DatasetName,'_',expNum,'_20.txt'), 'w');
fId4 = fopen(strcat(Folder2, 'PassiveLearnerBatchrunningtime_', DatasetName,'_',expNum,'_20.txt'), 'w');
fprintf(fId, '\n-----------------------------------------------------\n');
fprintf(fId2, '\n-----------------------------------------------------\n');
fprintf(fId, '\nDataset is %s\n',DatasetName);
fprintf(fId2, '\nDataset is %s\n',DatasetName);
