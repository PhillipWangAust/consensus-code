...
Folder2='../../Output_new/';
fId = fopen(strcat(Folder2, 'PassiveLearnerBatchnorel_', DatasetName, '_20.txt'), 'w');
fId2 = fopen(strcat(Folder2, 'PassiveLearnerBatchfScorenorel_', DatasetName, '_20.txt'), 'w');
fId3 = fopen(strcat(Folder2, 'PassiveLearnerBatchconfusionnorel_', DatasetName, '_20.txt'), 'w');
fId4 = fopen(strcat(Folder2, 'PassiveLearnerBatchrunningtimenorel_', DatasetName, '_20.txt'), 'w');
fprintf(fId, '\n-----------------------------------------------------\n');
fprintf(fId2, '\n-----------------------------------------------------\n');
fprintf(fId, '\nDataset is %s\n',DatasetName);
fprintf(fId2, '\nDataset is %s\n',DatasetName);
